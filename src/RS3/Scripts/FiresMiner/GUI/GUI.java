...
import RS3.Scripts.FiresMiner.Tasks.Actions.Walk.Mine_Walk;
...
public class GUI extends ClientAccessor {
	...
	private void initialise() {
		...
		Type.setModel(new DefaultComboBoxModel(new String[] { "Bank",
				"PowerMine" }));
		frame.add(Type);
